...
- Render aesthetic MUST follow `STYLE_INSTRUCTIONS` — hand-drawn ONLY for organic/sketch textures (sketch-notes, chalkboard, hand-drawn-edu, fantasy-animation); use clean/vector/flat for clean textures (editorial-infographic, corporate, minimal, scientific, notion, blueprint); reserve realistic/photographic renders for styles that explicitly call for them. Do NOT default to hand-drawn.
